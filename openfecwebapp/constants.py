...
table_columns = OrderedDict([
    ...
    ('reports-presidential', ['Committee ID', 'Report type', 'Coverage end date', 'Receipt date', 'Total receipts', 'Total disbursements']),
    ('reports-house-senate', ['Committee ID', 'Report type', 'Coverage end date', 'Receipt date', 'Total receipts', 'Total disbursements']),
    ('reports-pac-party', ['Committee ID', 'Report type', 'Coverage end date', 'Receipt date', 'Total receipts', 'Total disbursements', 'Total independent expenditures']),
    ('reports-ie-only', ['Committee ID', 'Report type', 'Coverage end date', 'Receipt date', 'Total contributions', 'Total independent expenditures'])
])
